      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            See how Roasty learns, remembers, and adapts to deliver personalized roasts
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-roast-dark rounded-lg border border-roast-orange/20 overflow-hidden">
            ...
            <div className="bg-roast-gray p-4 border-b border-roast-orange/20">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-white font-semibold">Roasty (+1 877-780-4236)</span>
              </div>
            </div>
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <div className="code-block rounded-lg p-4 font-mono">
